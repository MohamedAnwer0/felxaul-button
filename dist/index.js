...
function Button(_ref) {
  var _ref$type = _ref.type,
    ...
    label = _ref$label === void 0 ? "Flexa UI" : _ref$label,
    _ref$size = _ref.size,
    size = _ref$size === void 0 ? "medium" : _ref$size,
    _ref$color = _ref.color,
    color = _ref$color === void 0 ? "blue" : _ref$color,
    _ref$style = _ref.style,
    style = _ref$style === void 0 ? "full" : _ref$style,
    textColor = _ref.textColor,
    icon = _ref.icon,
    _ref$iconDirection = _ref.iconDirection,
    iconDirection = _ref$iconDirection === void 0 ? "left" : _ref$iconDirection,
    _ref$duration = _ref.duration,
    duration = _ref$duration === void 0 ? 200 : _ref$duration,
    _ref$animationOnClick = _ref.animationOnClick,
    animationOnClick = _ref$animationOnClick === void 0 ? false : _ref$animationOnClick,
  ...
  var colorList = {
    ...
    emerald: "bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 disabled:bg-emerald-300",
    ...
    fuchsia: "bg-fuchsia-600 hover:bg-fuchsia-700 border-fuchsia-600 hover:border-fuchsia-700 disabled:bg-fuchsia-300",
    ...
    neutral: "bg-neutral-600 hover:bg-neutral-700 border-neutral-600 hover:border-neutral-700 disabled:bg-neutral-300",
    stone: "bg-stone-600 hover:bg-stone-700 border-stone-600 hover:border-stone-700 disabled:bg-stone-300"
  };
  var styleVariants = {
    full: "".concat(colorList[color], " ").concat(textColor || "text-white"),
    border: "bg-transparent hover:bg-transparent border ".concat(colorList[color], " ").concat(textColor || "text-black")
  };
  var styleIcon = "flex items-center space-x-1 ".concat(iconDirection == "right" ? "flex-row-reverse" : "");
  ...
  return /*#__PURE__*/React.createElement(react.motion.button, {
    ...
    type: type,
    disabled: disabled,
    className: "rounded cursor-pointer transition-colors  disabled:cursor-no-drop ".concat(sizeClasses[size] || sizeClasses.medium, " ").concat(styleVariants[style] || styleVariants.full, "  ").concat(icon ? styleIcon : "", " ").concat(transitionDurations[duration] || "duration-200", " ")
  }, icon && /*#__PURE__*/React.createElement("span", null, icon), /*#__PURE__*/React.createElement("span", null, label));
}
Button.propTypes = {
